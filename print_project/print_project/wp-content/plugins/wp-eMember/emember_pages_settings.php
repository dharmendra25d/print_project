	    ...
	    <strong><i>Fields to be shown on the Edit profile form (Username, Password and Email address are mandatory fields and will always be present on the form).</i></strong><br /><br />
		    <table width="100%" border="0" cellspacing="0" cellpadding="6">    
				...
				<tr valign="top">
                    ...
                    <td align="left">
                        <input name="eMember_profile_thumbnail" type="checkbox"  <?php echo $emember_config->getValue('eMember_profile_thumbnail');?> value="1"/><br />
                        <i>Enable/Disable Profile Thumbnail image.</i><br /><br />                    
                    </td>
                </tr>	                    		    	    				       				        
		    </table>
	    </div>	    
