...
eMember_log_debug('Start Processing...',true);
...
$membership_level_name = $_REQUEST['membership_level_name'];
$membership_level_id = $_REQUEST['membership_level_id'];
...
$hashed_password = $wp_hasher->HashPassword($password);
	...
	if($ret === false){
		...
		if(isset($_REQUEST['openid_type'])){
		    $fields = array();
		    global $wpdb;
		    $fields['type'] = $_REQUEST['openid_type'];
		    $fields['openuid'] = $_REQUEST['openid_uid'];
		    $fields['emember_id'] = $wpdb->insert_id;
