	...
	?> 
	    <tr>
	       <td><label for="<?php echo $emember_field_name_index?>" class="eMember_label"><?php echo  $emember_field_name;?>: </label></td>
	       <td>
	       <?php	         
	       ...
	       <?php
	            ...
	            case 'dropdown':
	       ?>	
	       <select id="wp_emember_<?php echo $emember_field_name_index;?>" name="emember_custom[<?php echo $emember_field_name_index;?>]" class="eMember_text_input">
	       <?php
