					...
					<tr>
                     ...
                     <table cellspacing="5" cellpadding="3" width="100%">
                              ...
                              if($members)
                              {
                                 ...
                                 {
                                 ?>
                                 <div style="float: left; width: 130px;"><a href="#">· <?php echo $member->alias; ?></a></div>
                              ...
                              ?>
										<br clear="all"/>
                              <hr>
										<div style="float: left;">· Total Members</div>
				...
				<tbody>
					<tr>
                     ...
                     <table cellspacing="5" cellpadding="3" width="100%">
								<tbody><tr valign="top">
									<td width="50%" style="border: 1px solid rgb(238, 238, 238); background: rgb(248, 248, 248) none repeat scroll 0% 0%; -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous; line-height: 1.5em;">
										<h3 style="margin: 0pt 0pt 5px;">News</h3>
                              A stitch in time saves nine. I couldn’t sew my way out of a bag, but it’s true advice for bloggers as well — a little bit of work on an upgrade now saves a lot of work fixing something later. Right now there is a worm making its way around old, unpatched versions of WordPress
									...
									<td width="50%" style="border: 1px solid rgb(238, 238, 238); background: rgb(248, 248, 248) none repeat scroll 0% 0%; -moz-background-clip: border; -moz-background-origin: padding; -moz-background-inline-policy: continuous; line-height: 1.5em;">
										<h3 style="margin: 0pt 0pt 5px;">Support</h3>
										<a target="_blank" href="#">» Customer Support</a><br/>
										<a target="_blank" href="#">» Video Tutorials</a><br/>
										<a target="_blank" href="#">» Help Guide</a><br/>
										<a target="_blank" href="#">» FAQ's</a><br/>
										 <br/>
									</td>
								</tr>
							</tbody></table>
