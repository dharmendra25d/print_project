							...
							<div class="ctrlHolder">
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="6">
									<tr>
										...
										<td>
											<input type="text" name="emember_field_name[<?php echo $i?>]" id="name_<?php echo ($i);?>" value="<?php echo htmlspecialchars(stripslashes($fields['emember_field_name'][$i]));?>" class="textInput removable" />
									...
									<tr>
										...
										<td>
											<select  name="emember_field_type[<?php echo $i?>]" id="emember_field_type_<?php echo ($i);?>" class="textInput removable" >
									...
									<tr>
										...
										<td>
											<textarea name="emember_field_extra[<?php echo $i?>]" id="extra_<?php echo ($i);?>"  rows="1" cols="70"  class="textInput removable" ><?php echo stripslashes($fields['emember_field_extra'][$i]);?></textarea>
										</td>
										<td></td>									
									</tr>
									<tr>
										...
										<td>								
										<input type="text" size="4" maxlength="4" name="emember_field_order[<?php echo $i?>]" id="nameindex_<?php echo ($i);?>" value="<?php echo $fields['emember_field_order'][$i];?>" class="textInput removable onlynumber displayorder" />	
