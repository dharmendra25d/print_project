	...
	<div class="wrap"><h3>WP eMembers - Email Settings</h3>
		<div id="poststuff">
			<div id="post-body">
				...
				<div class="postbox">	
				   <h3><label for="title">Email After the Account Gets Expired (A member will get this email after the day his/her account is expired)</label></h3>		
					<div class="inside">
					<br /><strong>Please enable the Auto Expiry Email Notification feature from the <a href="admin.php?page=eMember_settings_menu" target="_blank">Settings Page</a> if you want to use this feature</strong><br /><br />
					    <table width="100%" border="0" cellspacing="0" cellpadding="6">
						    <tr valign="top">
							    <td width="25%" align="left">From Email Address</td>
							    <td align="left">
